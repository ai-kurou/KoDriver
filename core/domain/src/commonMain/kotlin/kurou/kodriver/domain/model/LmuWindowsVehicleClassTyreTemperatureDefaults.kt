...
const val LMU_WINDOWS_VEHICLE_CLASS_TYRE_TEMPERATURE_HIGH_THRESHOLD_CELSIUS_HYPERCAR_DEFAULT = 90
...
/**
 * 車両クラスごとの高温警告しきい値のデフォルト値（摂氏）。GTE は他クラスよりタイヤ温度が
 * 高くなる傾向があるため 100℃、それ以外のクラスは 90℃ を既定値とする。
 */
