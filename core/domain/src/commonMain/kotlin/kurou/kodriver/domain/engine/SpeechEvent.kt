...
sealed interface SpeechEvent {
    ...
    data object BlueFlag : SpeechEvent { override val readoutItemKey = ReadoutItemKey.LmuWindows.Flag }
    data object YellowFlag : SpeechEvent { override val readoutItemKey = ReadoutItemKey.LmuWindows.Flag }
    data object FullCourseYellow : SpeechEvent { override val readoutItemKey = ReadoutItemKey.LmuWindows.Flag }
    data object SessionStop : SpeechEvent { override val readoutItemKey = ReadoutItemKey.LmuWindows.Flag }
    data object Overheating : SpeechEvent { override val readoutItemKey = ReadoutItemKey.LmuWindows.VehicleDamage }
