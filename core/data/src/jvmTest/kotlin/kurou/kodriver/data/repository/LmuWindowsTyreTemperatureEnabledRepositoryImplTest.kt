...
class LmuWindowsTyreTemperatureEnabledRepositoryImplTest {

    private val tempDir = Files.createTempDirectory("kodriver_lmu_tyre_temperature_enabled_test").toFile()
    ...
    private val repository = LmuWindowsTyreTemperatureEnabledRepositoryImpl(
    ...
    @Test
    fun `初期値は false`() = testScope.runTest {
