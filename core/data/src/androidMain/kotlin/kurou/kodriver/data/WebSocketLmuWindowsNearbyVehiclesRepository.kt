...
internal class WebSocketLmuWindowsNearbyVehiclesRepository(
            ...
            .flatMapLatest { ip ->
                if (ip == null) {
                    ...
                    client.webSocketFlow(
                        host = ip,
                        port = port,
                        path = KoDriverServerFeature.NEARBY_VEHICLES.webSocketPath(Simulator.LmuWindows),
                        retryDelayMs = retryDelayMs,
                        decode = { json.decodeFromString<LmuWindowsNearbyVehiclesData>(it) },
                    )
                }
            }
}
