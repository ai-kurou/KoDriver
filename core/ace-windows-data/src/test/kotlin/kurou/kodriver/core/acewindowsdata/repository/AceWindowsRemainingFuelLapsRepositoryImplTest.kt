...
class AceWindowsRemainingFuelLapsRepositoryImplTest {
    ...
    fun `reader が open 済みのときデータを emit する`() =
        runTest {
            ...
            val repo = AceWindowsRemainingFuelLapsRepositoryImpl(source = makeSource(fake))

            repo.remainingFuelLapsStream().first()
        }
}
