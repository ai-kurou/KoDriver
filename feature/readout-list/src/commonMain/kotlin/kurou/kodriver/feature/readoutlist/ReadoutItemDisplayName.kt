...
import kodriver.feature.readoutlist.generated.resources.item_ace_no_flag
...
private fun aceFlagItemDisplayName(flag: ReadoutItemKey.AceWindows.Flag): String = when (flag) {
    ...
    is ReadoutItemKey.AceWindows.Flag.NoFlag -> stringResource(Res.string.item_ace_no_flag)
    is ReadoutItemKey.AceWindows.Flag.WhiteFlag -> stringResource(Res.string.item_ace_white_flag)
    is ReadoutItemKey.AceWindows.Flag.GreenFlag -> stringResource(Res.string.item_ace_green_flag)
    is ReadoutItemKey.AceWindows.Flag.RedFlag -> stringResource(Res.string.item_ace_red_flag)
    is ReadoutItemKey.AceWindows.Flag.BlueFlag -> stringResource(Res.string.item_ace_blue_flag)
    is ReadoutItemKey.AceWindows.Flag.YellowFlag -> stringResource(Res.string.item_ace_yellow_flag)
    is ReadoutItemKey.AceWindows.Flag.BlackFlag -> stringResource(Res.string.item_ace_black_flag)
    is ReadoutItemKey.AceWindows.Flag.BlackWhiteFlag -> stringResource(Res.string.item_ace_black_white_flag)
    is ReadoutItemKey.AceWindows.Flag.CheckeredFlag -> stringResource(Res.string.item_ace_checkered_flag)
    is ReadoutItemKey.AceWindows.Flag.OrangeCircleFlag -> stringResource(Res.string.item_ace_orange_circle_flag)
...
internal fun itemDisplayName(itemId: ReadoutItemKey): String = when (itemId) {
    ...
    is ReadoutItemKey.AceWindows.Flag -> aceFlagItemDisplayName(itemId)
