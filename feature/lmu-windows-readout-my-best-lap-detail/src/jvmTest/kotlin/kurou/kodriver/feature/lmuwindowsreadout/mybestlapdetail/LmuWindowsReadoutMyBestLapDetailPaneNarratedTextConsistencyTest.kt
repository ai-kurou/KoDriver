 ...
 */
class LmuWindowsReadoutMyBestLapDetailPaneNarratedTextConsistencyTest {
    @get:Rule
    ...
    fun `Chip表示文言がSpeechEventのnarratedTextと一致する`() {
        ...
        listOf(
            SpeechEvent.LmuWindowsMyBestLapFormal.narratedText,
            SpeechEvent.LmuWindowsMyBestLapCasual.narratedText,
