...
import kodriver.feature.telemetryloglist.generated.resources.readout_item_ace_black_flag
import kodriver.feature.telemetryloglist.generated.resources.readout_item_ace_black_white_flag
...
import kodriver.feature.telemetryloglist.generated.resources.readout_item_ace_white_flag
import kodriver.feature.telemetryloglist.generated.resources.readout_item_ace_yellow_flag
...
private fun aceFlagDisplayName(flag: ReadoutItemKey.AceWindows.Flag): String = when (flag) {
    ...
    is ReadoutItemKey.AceWindows.Flag.BlueFlag -> stringResource(Res.string.readout_item_ace_blue_flag)
    is ReadoutItemKey.AceWindows.Flag.YellowFlag -> stringResource(Res.string.readout_item_ace_yellow_flag)
    is ReadoutItemKey.AceWindows.Flag.BlackFlag -> stringResource(Res.string.readout_item_ace_black_flag)
    is ReadoutItemKey.AceWindows.Flag.BlackWhiteFlag ->
        stringResource(Res.string.readout_item_ace_black_white_flag)
    is ReadoutItemKey.AceWindows.Flag.CheckeredFlag -> stringResource(Res.string.readout_item_ace_checkered_flag)
...
internal fun readoutItemDisplayName(readoutItemKey: ReadoutItemKey): String =
    when (readoutItemKey) {
        ...
        is ReadoutItemKey.AceWindows.Flag -> aceFlagDisplayName(readoutItemKey)
