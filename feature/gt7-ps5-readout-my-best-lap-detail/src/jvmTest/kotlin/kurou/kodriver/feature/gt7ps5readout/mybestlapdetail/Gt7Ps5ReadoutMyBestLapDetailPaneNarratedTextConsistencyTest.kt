 ...
 */
class Gt7Ps5ReadoutMyBestLapDetailPaneNarratedTextConsistencyTest {
    @get:Rule
    ...
    fun `Chip表示文言がSpeechEventのnarratedTextと一致する`() {
        ...
        listOf(
            SpeechEvent.Gt7Ps5MyBestLapFormal.narratedText,
            SpeechEvent.Gt7Ps5MyBestLapCasual.narratedText,
