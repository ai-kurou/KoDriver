 ...
 */
class LmuWindowsReadoutRemainingVirtualEnergyDetailPaneNarratedTextConsistencyTest {
    @get:Rule
    ...
    fun `Chip表示文言がSpeechEventのnarratedTextと一致する`() {
        ...
        val narratedText = SpeechEvent.RemainingVirtualEnergyWarning.narratedText
