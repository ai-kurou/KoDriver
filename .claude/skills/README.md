...
以下のSkillは [chrisbanes/skills](https://github.com/chrisbanes/skills)（Apache License 2.0）から取り込んだもの。KotlinおよびJetpack Composeの実装規約（`CLAUDE.md`）と方向性が一致する2件を選定した。ライセンス全文は各ディレクトリの `LICENSE` を参照。
